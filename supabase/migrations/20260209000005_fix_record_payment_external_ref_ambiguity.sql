...
-- =============================================================================
-- Fix record_payment RPC: Resolve "external_ref is ambiguous" error
-- =============================================================================
-- The RETURNING clause references "external_ref" which is ambiguous because:
-- - It exists as a parameter (p_external_ref)
-- - It exists as a variable (v_external_ref)
-- - It exists as a column (payments.external_ref)
-- - It exists as a return column name (external_ref in RETURNS TABLE)
--
-- Solution:
-- 1. Add #variable_conflict use_variable directive
-- 2. Qualify all column references with table aliases
-- 3. Use payments.external_ref in RETURNING clause
-- =============================================================================
