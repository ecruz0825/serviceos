-- =============================================================================
-- Fix Collections Queue Customer Name Reference
-- =============================================================================
-- Fixes "column c.name does not exist" error by using the correct customer
-- table column (full_name) instead of non-existent name column.
-- =============================================================================

BEGIN;

-- Drop and recreate the function with corrected customer name reference
DROP FUNCTION IF EXISTS public.get_collections_queue_for_company(int, timestamptz);
