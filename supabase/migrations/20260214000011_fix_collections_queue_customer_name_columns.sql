-- =============================================================================
-- Fix Collections Queue Customer Name Columns
-- =============================================================================
-- Simplifies customer_name to use only full_name and email columns.
-- Removes references to first_name, last_name, and name (which don't exist).
-- =============================================================================

BEGIN;

-- Drop and recreate the function with simplified customer name logic
