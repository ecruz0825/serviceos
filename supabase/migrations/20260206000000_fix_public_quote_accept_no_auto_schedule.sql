...
-- =============================================================================
-- Fix public quote acceptance to NOT auto-schedule jobs
-- When a customer accepts a quote via /quote/:token, the job should land in
-- RevenueHub → Needs Scheduling, so service_date and scheduled_end_date should
-- default to NULL unless a date is explicitly provided.
-- =============================================================================
