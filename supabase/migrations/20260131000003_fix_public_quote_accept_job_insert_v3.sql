...
-- =============================================================================
-- Fix respond_to_quote_public() to use correct jobs table column names
-- Uses service_date (not scheduled_date) and ensures scheduled_end_date is set
-- =============================================================================
...
BEGIN
  ...
  IF p_action = 'accept' THEN
    ...
    -- Use service_date (nullable) and scheduled_end_date (NOT NULL - required)
    -- Set both to CURRENT_DATE as placeholders - admin can reschedule later
